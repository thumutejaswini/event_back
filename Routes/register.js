...
Router.post("/Insert", (req, res) => {
  ...
  console.log(Details);
  register.register("reg", "Insert", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.delete("/Delete:name", (req, res) => {
  ...
  register.register("reg", "Delete", Details)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.put("/Update:name", (req, res) => {
  ...
  console.log(Details);
  register.register("reg", "Update", Details, UpdatedDetails)
    .then((result) => {
      res.send(result);
      console.log(result);
    })
...
Router.get("/Read:name", (req, res) => {
  ...
  console.log(Details);
  register.register("reg", "Read", Details)
    .then((result) => {
